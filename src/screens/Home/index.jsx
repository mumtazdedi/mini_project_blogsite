                                ...
                                <div className='col-lg-3 col-md-4 col-sm-6 my-3'>
                                    <Card className='card_post' style={{ width: '18rem' }} key={postIdx}>
                                        ...
                                        <Card.Body>
                                            ...
                                            <Button onClick={() => handleShowMoreButton(post.id)} className="bg_primary">Show More</Button>
                                        </Card.Body>
                                    </Card>
                                </div>
                            ))}
                            ...
                            data.posts.length === 12 ? (
                                offset === 0 ? (
                                    <div className='row m-3'>
                                        <div className='col'>
                                            <button onClick={() => setOffset(offset + limit)} className='btn btn-sm bg_primary'>Halaman selanjutnya</button>
                                        </div>
                                    </div>
                                ) : (
                                    <div className='row m-3'>
                                        <div className='col'>
                                            <button onClick={() => setOffset(offset - limit)} className='btn btn-sm bg_primary'>Halaman sebelumnya</button>
                                        </div>
                                        <div className='col'>
                                            <button onClick={() => setOffset(offset + limit)} className='btn btn-sm bg_primary'>Halaman selanjutnya</button>
                                        </div>
