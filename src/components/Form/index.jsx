        ...
        <form onSubmit={handleSubmit}>
                ...
                <div key={inputIdx}>
                    {
                        input.type === 'hidden' ? (
                            ...
                            <label className='form-label mb-3'>{input.label}</label>
                        )
                    }
                    {
                        input.type === 'select' ? (
                            ...
                            input.label === 'Isi Konten' ? (
                                ...
                                input.label === 'Kategori' ? (
                                    ...
                                    <input
                                        ...
                                        disabled={input.label === "Penulis" ? true : false}
                                        required
                                    />
                                )
                            )
            ...
            </div>
            {
                isLoginPage ? (
                    ...
                    <div className='row mx-1'>
                        <button type='button' className='btn btn-outline-light mb-3' onClick={() => document.getElementById('uploadImage').click()}>Upload Foto</button>
                        <button type='submit' className='btn btn-light'>Submit</button>
                    </div>
                )
            }
